...
\hline
\textbf{Methods \& functionalities} & \pkg{NonProbEst} & \pkg{rstanarm} & \pkg{GJRM} & \pkg{balance} & \pkg{inps} & \pkg{nonprobsvy} \\
\hline
...
In should be noted that only \pkg{nonprobsvy} leveraged the use of the \pkg{survey} package to estimate analytic as well as bootstrap variance of the non-probability estimators. Furtheremore, none of the packages focusing on frequentist approach to statistical inference implements correct 
