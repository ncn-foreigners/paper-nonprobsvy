...
totals. The \pkg{inps} contains supports unit-level data from
...
the \pkg{scipy.stats} module \citep{scipy2020}. Neither \pkg{balance}
nor \pkg{ips} leverage usage of the \pkg{samplics} module
...
implemented solely in the \pkg{rstanarm} with variable selection
