...
one presented in the \textbackslash eqref\{\{eq-var-bootstrap\} where
the \(\hat{\mu}_y\) is replaced by one of the \eqref{eq-ipw-estimators}
estimators.
...
single_shift1 0.7083228 0.009339383
\end{CodeOutput}
\end{CodeChunk}
