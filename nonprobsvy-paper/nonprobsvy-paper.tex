...
properties. In the package we implement this approach using local
polynomial regression using \code{stats::loess} method.
...
\textbackslash code\{list\{\} of all the results returned by the MLE or
GEE estimation method. For example, the evaluation of coefficients can
