...
of non-probability sampling by a\textasciitilde proper reweighting to
reproduce known population totals/means, by modelling
\(E(Y|\boldsymbol{X})\) using various techniques or combining both
approaches (for instance doubly robust estimators,
cf.~\citet{chen2020doubly}; Multilevel Regression and
...
focuses solely on the IPW and uses stand
...
of the non-probability estimators. Furtheremore, none of the packages
...
\renewcommand\refname{Detailed derivations}
