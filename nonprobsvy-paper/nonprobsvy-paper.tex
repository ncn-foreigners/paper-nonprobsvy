...
\code{methods(class="nonprob")}. For instance, the \code{check_balance}
...
population totals; the \code{nobs} function returns the sample size of
...
In the package, we have implemented the \code{nonprob_method} to make it
easier for developers to implement new MI and IPW estimators. Users of
the package can access specific methods by calling \code{method_*}
functions, as shown in the example of the \code{method_glm()} function.
