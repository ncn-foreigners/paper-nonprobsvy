...
impute missing \(y_i\) values in the probability sample \(S_B\). The
detailed description is presented in the Algorithm \ref{algo-2} in the
Appendix.
...
single_shift1 0.7083228 0.009476960
\end{CodeOutput}
\end{CodeChunk}
