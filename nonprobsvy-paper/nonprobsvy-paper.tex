...
\begin{CodeChunk}
\begin{CodeInput}
R> mi_est1$outcome$single_shift$coefficients
\end{CodeInput}
\begin{CodeOutput}
(Intercept)    region04    region06    region08    region10    region12 
 0.18158023  0.16064873  0.49613781  0.50472026  0.37620622  0.33904794 
   region14    region16    region18    region20    region22    region24 
 0.16532636  0.25202192  0.15112240  0.08394541  0.15636759 -0.15168962 
   region26    region28    region30    region32     private     naceD.E 
 0.31160657  0.10733779  0.12500459  0.09079820 -0.66535673  0.19809638 
      naceF       naceG       naceH       naceI       naceJ     naceK.L 
 1.96624278 -0.49973896 -0.61576662 -1.15028767  1.06147195  1.09711267 
      naceM       naceN       naceO       naceP       naceQ     naceR.S 
 1.05205715 -0.21529286  1.52776138  0.54423406 -0.77546255 -0.88682910 
      sizeM       sizeS 
 1.05177086  1.60488041 
\end{CodeOutput}
\end{CodeChunk}

DR selection and outcome is exactly the same as it is based on the joint
estimation

\begin{CodeChunk}
\begin{CodeInput}
R> dr_est2$selection$single_shift$x
\end{CodeInput}
\begin{CodeOutput}
(Intercept)    region04    region06    region08    region10    region12 
-0.51717743  0.92917534  0.14794384  0.02811020 -0.33962403 -0.46737281 
   region14    region16    region18    region20    region22    region24 
-1.05343074  0.94716314  0.98620715  0.59354350 -0.26246150 -0.42078921 
   region26    region28    region30    region32     private     naceD.E 
 0.28109059  0.58442923 -0.43713897  0.19958205 -0.09395456  0.69148220 
      naceF       naceG       naceH       naceI       naceJ     naceK.L 
-0.40007411 -0.32715883 -0.64617455  0.40705788 -1.48486167  0.07245263 
      naceM       naceN       naceO       naceP       naceQ     naceR.S 
-0.34073542  0.64349258 -0.83113490  1.15829838  0.27323189  0.17453665 
      sizeM       sizeS (Intercept)    region04    region06    region08 
-0.37453707 -0.86709813  0.40191468  0.11653827  0.41441918  0.43590745 
   region10    region12    region14    region16    region18    region20 
 0.39386267  0.30788149  0.22671147  0.22845793  0.14044147 -0.02400042 
   region22    region24    region26    region28    region30    region32 
 0.11162524 -0.25013288  0.11116323  0.07546049  0.09347190  0.05471013 
    private     naceD.E       naceF       naceG       naceH       naceI 
-0.74136463 -0.06890333  1.80012499 -0.67000942 -0.92702864 -1.36247923 
      naceJ     naceK.L       naceM       naceN       naceO       naceP 
 0.90185178  0.63047204  1.07719957 -0.32227506  1.65945780  0.07401888 
      naceQ     naceR.S       sizeM       sizeS 
-1.09015534 -1.21074120  1.12767378  1.64672671 
\end{CodeOutput}
\end{CodeChunk}
...
\begin{CodeChunk}
\begin{CodeInput}
R> hist(weights(dr_est1), breaks = "fd")
\end{CodeInput}


\begin{center}\includegraphics{nonprobsvy-paper_files/figure-latex/unnamed-chunk-25-1} \end{center}
...
\begin{CodeChunk}
\begin{CodeInput}
R> res_glm <- method_glm(y_nons = admin$single_shift,
...
\begin{CodeChunk}
\begin{CodeInput}
R> method_ps("cloglog")$make_gradient
\end{CodeInput}
\begin{CodeOutput}
...
<bytecode: 0x1228779e0>
<environment: 0x12357f970>
\end{CodeOutput}
\end{CodeChunk}
...
also responsible for the significant restructurisation of the package
betwen 0.1.0 and 0.2.0 version and other.
