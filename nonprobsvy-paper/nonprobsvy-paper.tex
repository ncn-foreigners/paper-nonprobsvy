...
the mean which can be easily obtained from the \pkg{survey} package) and
...
single_shift1 0.7083228 0.008583870
\end{CodeOutput}
\end{CodeChunk}
...
$\hat{\mu}{PR1}$ & First prediction estimator \\
$\hat{\mu}{PR2}$ & Second prediction estimator \\
$\hat{\mu}{MI}$ & Mass imputation estimator \\
$\hat{\mu}{IPW1}$ & First inverse probability weighting estimator \\
$\hat{\mu}{IPW2}$ & Second inverse probability weighting estimator \\
$\hat{\mu}{DR1}$ & First doubly robust estimator \\
