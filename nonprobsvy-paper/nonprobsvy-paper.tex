...
The package is aimed at scientistcs or researchers who whould like to
...
access to the \code{"selection"} element is required. This is a
\code{list} of all the results returned by the MLE or GEE estimation
