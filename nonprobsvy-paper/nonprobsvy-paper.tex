...
\code{glm} or other functions known in \proglang{R}, together with the
main function to specify the approach and estimators. As far as we know,
the \pkg{nonprobsvy} is the only software (open-access or commercial)
...
\pkg{RcppArmadillo} \citep{RcppArmadillo} packages for improved
performance.
